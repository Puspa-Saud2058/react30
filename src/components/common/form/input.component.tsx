...
export const SubmitButton=({btnTxt,loading=false}:{btnTxt:String,loading:boolean})=>{
  return(
    <>
       ...
       type="submit" 
       disabled={loading}
       className="me-3 inline-flex items-center disabled:cursor-not-allowed bg-green-600 disabled:bg-teal-700/20 px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white  rounded-lg focus:ring-4 focus:ring-teal-200 dark:focus:ring-teal-900 hover:bg-teal-800">
